        ...
        <View>
            <Portal>
                <Dialog visible={isOpen} style={styles.dialog}>
                    ...
                    <Dialog.Title style={{ color: "#fff" }}>{t("screens.configuration_type_selector.dialog_title")}</Dialog.Title>

                    <Dialog.Content>
                        {/* <Paragraph>{t('screens.configuration_type_selector.dialog_explain')}</Paragraph> */}
                        <Paragraph style={{ color: "rgba(255,255,255,0.75)" }}>{t("screens.configuration_type_selector.dialog_explain")}</Paragraph>
                        <View>
                            <TextInput
                                mode="outlined"
                                value={name}
                                ...
                                theme={{
                                    colors: {
                                        ...
                                        onSurfaceVariant: "rgba(255,255,255,0.75)", // label
